          ...
          <div className="flex items-center">
            ...
            >
              <div className="flex flex-col">
                <span
                  className={`script-name text-lg md:text-xl transition-all duration-500 ${
                    isScrolled
                      ? "text-deep-maroon"
                ...
                <span
                  className={`text-xs md:text-sm font-sans italic -mt-1 transition-all duration-500 ${
                    isScrolled
                      ? "text-deep-maroon/70"
              ...
              >
                ...
                <span
                  className={`absolute -bottom-1 left-0 w-0 h-0.5 transition-all duration-300 group-hover:w-full ${
                    isScrolled ? "bg-rose-gold" : "bg-white"
                  }`}
                ></span>
              </a>
            ))}
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className={`md:hidden backdrop-blur-md rounded-b-lg mx-2 mb-2 overflow-hidden ${
                isScrolled
            ...
            >
              ...
              >
                ...
                <motion.a
                  href="#contact"
                  className={`block mx-3 mt-4 px-6 py-3 rounded-full text-center transition-all duration-300 font-medium ${
                    isScrolled
                      ? "bg-deep-maroon text-ivory hover:bg-deep-maroon/90"
